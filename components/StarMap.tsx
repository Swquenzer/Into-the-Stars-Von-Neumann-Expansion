...
import { GameState, SolarSystem, Probe, ProbeState, Relay } from "../types";
      ...
      >
        ...
        {relays.map((relay: Relay) => {
          return (
            <g
              key={relay.id}
              transform={`translate(${relay.position.x}, ${relay.position.y})`}
