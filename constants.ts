...
export const COST_MULTIPLIERS = {
  miningSpeed: { Metal: 20, Plutonium: 5 },
  flightSpeed: { Metal: 20, Plutonium: 20 }, // Expensive engines
  replicationSpeed: { Metal: 50, Plutonium: 50 }, // Complex machinery
  scanRange: { Metal: 0.1, Plutonium: 0.05 }, // Per LY
...
export const UPGRADE_COSTS = {
  miningSpeed: { Metal: 100, Plutonium: 10, increment: 1, name: 'Carbide Drills' },
  flightSpeed: { Metal: 100, Plutonium: 20, increment: 1, name: 'Ion Thrusters' },
  ...
  replicationSpeed: { Metal: 200, Plutonium: 50, increment: 0.5, name: 'Nano-Assembler' },
  autonomyLevel: { Metal: 500, Plutonium: 200, increment: 1, name: 'Neural Core' }
};

// Default Stats for reference and backward compatibility
export const PROBE_STATS: Record<ProbeModel, { miningSpeed: number; flightSpeed: number; replicationSpeed: number; scanRange: number; scanSpeed: number; autonomyLevel: number }> = {
  [ProbeModel.MarkI]: { miningSpeed: 1, flightSpeed: 1, replicationSpeed: 1, scanRange: 300, scanSpeed: 1, autonomyLevel: 0 },
  [ProbeModel.MarkII]: { miningSpeed: 1, flightSpeed: 3, replicationSpeed: 1, scanRange: 450, scanSpeed: 1.5, autonomyLevel: 0 },
  [ProbeModel.MarkIII]: { miningSpeed: 4, flightSpeed: 1, replicationSpeed: 1, scanRange: 300, scanSpeed: 1, autonomyLevel: 0 },
  [ProbeModel.VonNeumannPrime]: { miningSpeed: 3, flightSpeed: 2, replicationSpeed: 3, scanRange: 600, scanSpeed: 2, autonomyLevel: 0 },
};
...
export const DEFAULT_BLUEPRINTS: ProbeBlueprint[] = [
  ...
  },
  {
    ...
    stats: { miningSpeed: 1, flightSpeed: 4, replicationSpeed: 5, scanRange: 1000, scanSpeed: 50, autonomyLevel: 2 },
...
export const PROBE_COSTS: Record<ProbeModel, { Metal: number; Plutonium: number; time: number }> = {
